        ...
        >
          ...
          >
            ...
            <div className="bg-white p-3 rounded-2xl shadow-sm mb-4 flex gap-3">
               <div className="w-20 h-20 bg-zinc-200 rounded-xl overflow-hidden shrink-0">
                 <img src="https://images.unsplash.com/photo-1586190848861-99aa4a171e90?auto=format&fit=crop&q=80&w=400" alt="X-Tudo Monstro" className="w-full h-full object-cover" />
               </div>
            ...
            <div className="bg-white p-3 rounded-2xl shadow-sm mb-4 flex gap-3 relative border border-transparent">
               <div className="w-20 h-20 bg-zinc-200 rounded-xl overflow-hidden shrink-0">
                 <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&q=80&w=400" alt="Classic Burger" className="w-full h-full object-cover" />
               </div>
               <div className="flex-1">
            ...
            {/* Produto 3 */}
            <div className="bg-white p-3 rounded-2xl shadow-sm mb-4 flex gap-3">
               <div className="w-20 h-20 bg-zinc-200 rounded-xl overflow-hidden shrink-0 flex items-center justify-center p-2">
                 <img src="https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&q=80&w=400" alt="Coca-Cola" className="w-full h-full object-cover rounded-md" />
               </div>
               <div className="flex-1">
          ...
          >
            ...
            <div className="w-full h-40 bg-zinc-100 rounded-2xl mb-4 overflow-hidden relative border border-zinc-200 shadow-inner">
               <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&q=80&w=800" alt="Classic Burger" className="w-full h-full object-cover" />
