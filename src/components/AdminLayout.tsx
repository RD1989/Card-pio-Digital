        ...
        <div className="flex items-center gap-4 px-2 mb-10">
          ...
          {!collapsed && (
            <motion.h1 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-xl font-serif font-bold italic tracking-tighter"
        ...
        <div className="p-4 md:p-8">
          <header className="hidden md:flex justify-between items-center mb-10">
            <div>
              ...
              <p className={`text-sm ${isLight ? 'text-slate-500' : 'text-zinc-500'}`}>Olá, {user?.name}. Bem-vindo ao seu painel.</p>
            </div>
            
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className={`font-bold ${isLight ? 'text-slate-900' : 'text-white'}`}>{user?.name}</p>
