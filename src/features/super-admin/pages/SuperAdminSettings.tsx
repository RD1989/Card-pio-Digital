    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold flex items-center gap-2">
          Configurações Globais <span className="text-[10px] bg-primary/20 text-primary px-2 py-0.5 rounded-full font-black tracking-widest uppercase">v2.5 - Build ESM OK</span>
        </h1>
